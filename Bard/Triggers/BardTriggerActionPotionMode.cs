...
{
    public class BardTriggerActionPotionMode : ITriggerAction
    {
        public string DisplayName => "Bard/起手or2分钟爆发药";
        ...
        public bool Handle()
        {
            BardSettings.Instance.UsePotionInOpener = UsePotionInOpener;
            return true;
        }
    }
}