...
{
    public class BardTriggerActionNewQt : ITriggerAction
    {
        public string DisplayName { get; } = "Bard/New QT";
        ...
        public BardTriggerActionNewQt()
        {
            qtArray = BardRotationEntry.QT.GetQtArray();
        }
        ...
        public bool Handle()
        {
            foreach (var kvp in qtValues)
            {
                BardRotationEntry.QT.SetQt(kvp.Key, kvp.Value);
            }
            return true;
        }
    }
