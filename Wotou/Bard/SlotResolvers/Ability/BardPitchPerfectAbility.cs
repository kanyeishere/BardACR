...
public class BardPitchPerfectAbility : ISlotResolver
{
    ...
    public int Check()
    {
        ...
        if (Core.Resolve<JobApi_Bard>().Repertoire == 2 && EmpyrealArrow.GetSpell().Cooldown.TotalMilliseconds < 2300 && EmpyrealArrow.GetSpell().Cooldown.TotalMilliseconds > 600 && !EmpyrealArrow.RecentlyUsed())
            return 1;
        return -1;
    }
