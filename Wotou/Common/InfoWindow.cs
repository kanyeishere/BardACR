...
public class InfoWindow
{
    ...
    public static void Draw()
    {
        if (!InfoWindow.isWindowOpen)
            return;
        if (BardSettings.Instance.IsReadInfoWindow078)
            return;
        if (DancerSettings.Instance.IsReadInfoWindow078)
            return;
        ...
        if (ImGui.Button("已知悉"))
        {
            ...
            BardSettings.Instance.IsReadInfoWindow078 = true;
            DancerSettings.Instance.IsReadInfoWindow078 = true;
